...
import imgOne from "../../img/The Shawshank Redemption.jpg";
import imgTwo from "../../img/The Godfather.jpg";
import imgThree from "../../img/The Godfather Part II.jpg";
import imgFour from "../../img/The Godfather Part III.jpg";
import imgFive from "../../img/The Dark Knight.jpg";
import imgSix from "../../img/The Lord of the Rings The Return of the King.jpg";
import imgSeven from "../../img/Batman Begins.jpg";
import imgEight from "../../img/The Dark Knight Rises.jpg";
import imgNine from "../../img/The Lord of the Rings The Fellowship of the Ring.jpg";
import imgTen from "../../img/Schindler's List.jpg";
